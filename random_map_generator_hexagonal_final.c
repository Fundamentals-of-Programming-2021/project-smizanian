...
void map_generator(int number_of_players, int players_first_state[number_of_players][2], FILE* map_ptr) {
    ...
    for (int i=1; i<(HEXAGON_COUNT/CELL_NUM + 1)/2 - 1; i++) { //(HEXAGON_COUNT/CELL_NUM + 1)/2 --------------- 4
    ...
    for (int i = 1; i <= (SCREEN_HEIGHT/((int)(2*HEXAGON_SIDE*0.866025)-1)-2 - 1); i++) { //(SCREEN_HEIGHT/((int)(2*a*0.866025)-1)-2 - 1) ------ 4
